...
contract PlantToken is BEP20, Ownable {
    ...
    /**
     * All of the minted 'Plant' will be moved to the mainPool.
     */
    ...
    /**
     * All of the minted 'Plant' burned in the corresponding mining pool if the released amount is not used up in the current year 
     * 
     */
    ...
    constructor() 
        public 
        BEP20("DigiPlant", "PLANT", 18) 
    {
        uint256 decimal = 10 ** uint256(decimals);
        /**
        * There will distribute 400,000,000 Plant in year 1
        *                       225,000,000 Plant in year 2
        *                       175,000,000 Plant in year 3
        *                       125,000,000 Plant in year 4
        *                       75,000,000  Plant in year 5
        *  In the future, up to 50,000,000 Plant can be released each year
        */
    ...
    /**
     * Distribute Plant to the main mining pool according to the Plant limit that can be released every year
     */
